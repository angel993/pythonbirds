...
if __name__ == '__main__':
    ...
    silvestre = Pessoa(Angel, nome='Silvestre')
    print(Pessoa.cumprimentar(silvestre))
    print(id(silvestre))
    print(silvestre.cumprimentar())
    print(silvestre.nome)
    ...
    Pessoa.olhos = 3
    print(Pessoa.olhos)
    print(silvestre.olhos)
    print(Angel.olhos)
    print(id(Pessoa.olhos),id(Angel.olhos), id(silvestre.olhos))
